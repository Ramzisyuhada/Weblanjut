            ...
            <div class="panel-body">
                ...
                <?php echo csrf_field(); ?>    
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="password" placeholder="Masukkan alamat Anda .." value="">
                    </div>
...
<?php echo $__env->make('user.template.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laundry_uas1\resources\views//user/edituser.blade.php ENDPATH**/ ?>